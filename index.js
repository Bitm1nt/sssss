...
function initializeArtModal() {
    ...
    // Enhanced protection against dev tools
    function detectDevTools() {
        const threshold = 160; // Height difference when dev tools open
        const check = () => {
            if (window.outerHeight - window.innerHeight > threshold || 
                window.outerWidth - window.innerWidth > threshold) {
                // Dev tools detected - close modal
                closeModal();
                // Show warning
                ...
                warning.style.cssText = `
                    ...
                    text-align: center;
                `;
                warning.innerHTML = '<h3>⚠️ Developer Tools Detected</h3><p>Please close developer tools to view the artwork.</p>';
                ...
                <div class="support-artist-section">
                    ...
                    <div class="donation-platforms">
                        <div class="donation-platform" onclick="showZelleQR()">
                            <img src="images/zelle.png" alt="Zelle" class="platform-logo">
                        ...
                        <div class="donation-platform" onclick="copyToClipboard('Devil0fish', 'Venmo')">
                            <img src="images/venmo.png" alt="Venmo" class="platform-logo">
                        ...
                        <div class="donation-platform" onclick="copyToClipboard('$devil0fish', 'Cash App')">
                            <img src="images/cashapp.png" alt="Cash App" class="platform-logo">
                        ...
                        <div class="donation-platform" onclick="window.open('https://www.instagram.com/teeth.grind?igsh=MTNvMW9yMHgxaTVxMQ%3D%3D&utm_source=qr', '_blank')">
                            <img src="images/ig.png" alt="Instagram" class="platform-logo">
